...
<body>
  ...
  <div class="container-wrapper">
    <div class="container">
      <?php if ($username) { ?>
        <a href="add_category.php" class="add_category">新增分類</a>
      <?php }?>
        ...
        <?php while ($row = $result->fetch_assoc()) {?>
          <div class="admin-post">
            ...
            <div class="admin-post__info">
              ...
              <?php if ($username) { ?>
                <a class="admin-post__btn" href="edit_categories.php?id=<?php echo escape($row['id']) ?>">
                  編輯
                </a>
                <a class="admin-post__btn" href="handle_delete_categories.php?id=<?php echo escape($row['id']) ?>">
                  刪除
                </a>
              <?php } ?>  
            </div>
